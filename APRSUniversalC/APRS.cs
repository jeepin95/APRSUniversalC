/*
 * .NET APRS Parser Version 0.4 Copyright (C) 2009 Terry E Trapp, KE4PJW
 * 
               ...
               */ 
                ...
                if (FirstChr != -1)
                {
                    ...
                    if (FirstChr != -1)
                    {
                        ...
                        double degLatMin = Convert.ToDouble(degLatitude.Substring(2, degLatitude.Length - 2));
                        ...
                        double degLonMin = Convert.ToDouble(degLongitude.Substring(3, degLongitude.Length - 3));
                        ...
                        Altitude = Convert.ToString(Convert.ToDouble(Split[9]));
                    }
                    ...
                    if ((FirstChr != -1) || (SecondChr != -1))
                    {
                        ...
                        double degLatMin = Convert.ToDouble(Convert.ToString(Convert.ToInt16(DestinationArray[2]) & 0x0F) + Convert.ToString(Convert.ToInt16(DestinationArray[3]) & 0x0F) + "." + Convert.ToString(Convert.ToInt16(DestinationArray[4]) & 0x0F) + Convert.ToString(Convert.ToInt16(DestinationArray[5]) & 0x0F));
                        degLatMin = (degLatMin / 60);
                        ...
                        degLonMin = Convert.ToDouble(Convert.ToString(degLonMin) + "." + Convert.ToString(Convert.ToInt16(InformationField[3]) - 28));
                        degLonMin = (degLonMin / 60);
                        ...
                        Speed = Convert.ToString(((Convert.ToDouble((Convert.ToInt16(InformationField[4])) - 28) * 10) + (Math.Floor((Convert.ToDouble(Convert.ToInt16(InformationField[5])) -28 )/10))) % 800);
                        Heading = Convert.ToString((((((Convert.ToDouble(Convert.ToInt16(InformationField[5])) - 28) / 10) - Math.Floor((Convert.ToDouble(Convert.ToInt16(InformationField[5])) - 28) / 10)) * 1000) + (Convert.ToDouble(Convert.ToInt16(InformationField[6])) - 28 )) % 400);
                        ...
                        (SecondChr != -1 && line.Substring((SecondChr + 9), 1).ToUpper() == "N"))
                    {
                        ...
                        double degLatMin = Convert.ToDouble(line.Substring(FirstChr + 11, 5));
                        degLatMin = (degLatMin / 60);
                        ...
                        double degLonMin = Convert.ToDouble(line.Substring(FirstChr + 21, 5));
                        degLonMin = (degLonMin / 60);
                        Longitude = line.Substring(FirstChr + 18, 3) + Convert.ToString(degLonMin).Substring(1, Convert.ToString(degLonMin).Length - 1);
